...
function hideSnowflake(snowflake) {
    snowflake.style.display = "none";
}


for (i=0;i<=snowmax;i++) {
    document.write("<span id='s" + i + "' style='cursor:pointer;position:absolute;top:-" + snowmaxsize + "' onclick='hideSnowflake(this)'>" + snowletter + "</span>");
}
